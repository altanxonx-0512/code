...
<head>
  ...
  <title>Sys&CoTech — Packages</title>

  <!-- Google font (солих боломжтой) -->
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;700;800&display=swap" rel="stylesheet">

  <style>
    :root{
      --bg:#0f1720;            /* page background */
      --panel:#0b1116;         /* inner panel */
      --card:#0e161b;          /* card background */
    ...
    *{box-sizing:border-box}
    ...
    body{
      margin:0;
      background: linear-gradient(180deg, #0b0f12 0%, #10171b 60%), var(--bg);
      color:#e6eef3;
    ...
    .brand img{height:36px; width:auto; display:block; filter: drop-shadow(0 2px 6px rgba(0,0,0,0.6)); }
    .brand .title{
      font-weight:700;color:#cfe9e6;letter-spacing:0.6px;font-size:15px;
    }
...
<body>
  ...
  <header class="topbar">
    ...
    <div style="margin-left:16px; font-weight:600; font-size:15px;">hugjuuleltiin task</div>
